About mapbox-vector-tile-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mapbox-vector-tile-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mapbox-vector-tile-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mapbox-vector-tile
# for installing globally
pixi global install mapbox-vector-tile
```
...
It is possible to list all of the versions of `mapbox-vector-tile` available on your platform:
...
```
pixi search mapbox-vector-tile --channel conda-forge
```
